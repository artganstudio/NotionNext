...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/8f66c00608a14de398f0474a91278c2b
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '8f66c00608a14de398f0474a91278c2b',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个设计师, Hi，这里是artganSTUDIO的频道,Hi,欢迎来到我的设计事务所',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Artgan STUDIO', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '欢迎来到我的频道', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://artganstudio.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Artgan STUDIO, 博客,室内设计博客，建筑设计师', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'gwjok1@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,weibo,email,facebook,twitter', // 分享的服務，按顺序显示,逗号隔开
  // 所有支持的分享服务：link(复制链接),wechat(微信),weibo(微博),email(邮件),facebook,twitter
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'artganSTUDIO BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
